package com.crui.controller.file;
...
//    }
    ...
    public String ossUpload(@RequestParam("file") MultipartFile file, String folder){
        ...
        //System.out.println("ossClient.getBucketWebsite="+ossClient.getBucketWebsite(bucketName));
        ...
        return "https://crui990-1.oss-cn-shenzhen.aliyuncs.com/" + fileName;
    }
