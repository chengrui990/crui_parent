...
import com.crui.util.BCryptUtil;
import com.github.pagehelper.Page;
import com.github.pagehelper.PageHelper;
import com.crui.dao.AdminMapper;
...
//        if (loginName.equals(SecurityContextHolder))
        map.put("status","1");
        ...
        //校验旧密码
        if (!BCryptUtil.checkpw(oldPass, admin.getPassword())){
            throw new RuntimeException("原密码错误");
        }
        String password = BCryptUtil.hashpw(map.get("newPass").toString(), BCryptUtil.gensalt());
