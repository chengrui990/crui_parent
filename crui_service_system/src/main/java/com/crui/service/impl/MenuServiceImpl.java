...
import com.crui.dao.MenuMapper;
import com.crui.entity.PageResult;
import com.crui.pojo.system.Menu;
import com.crui.service.system.MenuService;
...
public class MenuServiceImpl implements MenuService {
    ...
    public List<Map> findAllMenu() {
        //方式一：首先查菜单id为0的列表，再循环一级一级的往下查（不推荐）
        List<Menu> menuList = findAll();
        //方式二：先查出所有符合条件的菜单，再通过内存判断筛选出符合条件的记录
